...
By default messages will be auto-dismissed after 8 seconds. You can turn
this off by setting an ir.config_param like:
...
Go to /cms/status-message/display-test to see how messages will look
like when your theme is applied.
